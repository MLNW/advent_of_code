...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `66.0µs` | `658.4µs` |
| [Day 2](./src/bin/02.rs) | `42.3µs` | `50.0µs` |
| [Day 3](./src/bin/03.rs) | `447.4µs` | `432.1µs` |
| [Day 4](./src/bin/04.rs) | `97.3µs` | `19.3ms` |
| [Day 5](./src/bin/05.rs) | `30.3µs` | `26.5s` |
| [Day 6](./src/bin/06.rs) | `543.0ns` | `38.1ms` |
| [Day 7](./src/bin/07.rs) | `123.6µs` | `123.0µs` |
| [Day 8](./src/bin/08.rs) | `255.4µs` | `1.7ms` |
| [Day 9](./src/bin/09.rs) | `107.0µs` | `109.6µs` |
